...
import hodoku.chinesization.generator.SudokuGenerator;
...
import hodoku.chinesization.sudoku.dialog.AboutDialog;
import hodoku.chinesization.sudoku.emuns.ClipboardMode;
import hodoku.chinesization.sudoku.entity.*;
import hodoku.chinesization.sudoku.panel.CellZoomPanel;
import hodoku.chinesization.sudoku.panel.MainFrame;
import hodoku.chinesization.sudoku.panel.SolutionPanel;
import hodoku.chinesization.sudoku.solver.AlsInSolutionStep;
import hodoku.chinesization.sudoku.solver.ProgressChecker;
...
//                System.out.println("Timer stopped");
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/SudokuPanel"); // NOI18N
...
//        handleMouseClicked(evt, evt.getClickCount() == 2);
    ...
    private void excludeSeveralMenuItemActionPerformed(ActionEvent evt) {//GEN-FIRST:event_excludeSeveralMenuItemActionPerformed
        String input = JOptionPane.showInputDialog(this,
                PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.cmessage"),
                PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.ctitle"),
        ...
        if (!sudoku.isFixed(index) && sudoku.getValue(index) != number) {
            ...
            if (sudoku.isSolved() && Options.getInstance().isShowSudokuSolved()) {
                JOptionPane.showMessageDialog(this,
                        PropertyUtil.getProperty("intl/MainFrame","MainFrame.sudoku_solved"),
                        PropertyUtil.getProperty("intl/MainFrame","MainFrame.congratulations"),
...
//        double leftDx = cs3 / 6.0;
    ...
    public void setSudoku(String init, boolean alreadySolved) {
        ...
        if (init == null || init.length() == 0) {
            ...
            if (anzSolutions == 0) {
                JOptionPane.showMessageDialog(this,
                        PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.no_solution"),
                        PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.invalid_puzzle"),
                        JOptionPane.ERROR_MESSAGE);
                sudoku.setStatus(SudokuStatus.INVALID);
            } else if (anzSolutions > 1) {
                JOptionPane.showMessageDialog(this,
                        PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.multiple_solutions"),
                        PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.invalid_puzzle"),
                        JOptionPane.ERROR_MESSAGE);
                ...
                if (!sudoku.checkSudoku()) {
                    JOptionPane.showMessageDialog(this,
                            PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.wrong_values"),
                            PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.invalid_puzzle"),
                            JOptionPane.ERROR_MESSAGE);
                    sudoku.setStatus(SudokuStatus.INVALID);
                } else {
        ...
        if (i.hasNext()) //there's at least one ImageWriter, just use the first one
        {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, e.getLocalizedMessage(),
                        PropertyUtil.getProperty("intl/SudokuPanel","SudokuPanel.error"),
                        JOptionPane.ERROR_MESSAGE);
            }
...
//            System.out.println("clear cell: ");
     ...
     * {@link CellZoomPanel#update(sudoku.SudokuSet, sudoku.SudokuSet, int, boolean, SortedMap, SortedMap) CellZoomPanel.update()}.
     */
