...
import hodoku.chinesization.solver.RestrictedCommon;
import hodoku.chinesization.sudoku.*;
import hodoku.chinesization.sudoku.solver.AlsInSolutionStep;
...
public class SolutionStep implements Comparable<SolutionStep>, Cloneable, Serializable {
    ...
    // FIXME update false -> true
    private static final boolean DEBUG = true;
    // FIXME 去除 static
    private final String[] entityNames = {
        PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.block"),
        PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.line"),
        PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.col"),
        PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.cell")
    };
...
//                            int alsIndex = Chain.getSCellIndex2(chain[i]);
    ...
    public String getCandidateString(boolean library, boolean statistics) {
        ...
        if (library) {
            ...
            if (statistics) {
                ...
                if (isSiamese) {
                    tmpStepName = PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.siamese")
                            + " " + getStepName();
                }
    ...
    public final void setType(SolutionType type) {
        ...
        if (!found) {
            throw new RuntimeException(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.invalid_setType") + " (" + type + ")");
        }
        this.type = type;
    }
    ...
    public void addValue(int value) {
        if (value < 1 || value > 9) {
            throw new RuntimeException(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.invalid_setValue") + " (" + value + ")");
        }
        values.add(value);
    }
    ...
    public void addIndex(int index) {
        if (index < 0 || index > 80) {
            throw new RuntimeException(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.invalid_setIndex") + " (" + index + ")");
        }
        indices.add(index);
    }
    ...
    public String toString(int art) {
        ...
        switch (type) {
            ...
            case LOCKED_PAIR:
                ...
                if (art >= 2) {
                    tmp.append(" ");
                    tmp.append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in"));
                    tmp.append(" ");
            ...
            case LOCKED_CANDIDATES_2:
                ...
                if (art >= 2) {
                    str += " "
                            + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in")
            ...
            case DUAL_TWO_STRING_KITE:
                ...
                if (art >= 2) {
                    str += " " + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in") + " "
                    ...
                    str += " ("
                           + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.connected_by") + " "
            ...
            case DUAL_EMPTY_RECTANGLE:
                ...
                if (art >= 2) {
                    str += " " + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in") + " " + getEntityShortName() + getEntityNumber()
                            + " (" + getCompactCellPrint(indices, 0, 1);
            ...
            case W_WING:
                ...
                if (art >= 2) {
                    ...
                    tmp.append(" ");
                    tmp.append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.connected_by"));
                    tmp.append(" ");
                    tmp.append(values.get(1));
                    tmp.append(" ");
                    tmp.append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in"));
            ...
            case XYZ_WING:
                ...
                if (art >= 2) {
                    str += "/" + values.get(2) + " " + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in") + " " + getCompactCellPrint(indices);
                    tmp = new StringBuffer(str);
                    getCandidatesToDelete(tmp);
                    str = tmp.toString();
                }
...
//                    }
            ...
            case FORCING_NET_VERITY:
                ...
                if (art >= 2) {
                    if (type == SolutionType.FORCING_CHAIN_CONTRADICTION
                        ...
                        str += " " + PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.in") + " " + getEntityShortNameNumber();
                    } else {
                        //str += " Verity";
                    }
                    if (indices.size() > 0) {
            ...
            case KRAKEN_FISH_TYPE_2:
                ...
                if (isSiamese) {
                    tmp.append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.siamese")).append(" ");
                }
            ...
            case ALS_XY_CHAIN:
                ...
                if (restrictedCommons.isEmpty()) {
                    ...
                    if (art == 1) {
                        tmp = new StringBuffer(str + ": ");
                        tmp.append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.start")).append("=");
                        getAls(tmp, 0);
                        tmp.append(", ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.end")).append("=");
            ...
            case BRUTE_FORCE:
                ...
                break;
            case INCOMPLETE:
                str = PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.incomplete_solution");
                break;
            case GIVE_UP:
                tmp = new StringBuffer();
                tmp.append(getStepName());
                if (art >= 1) {
                    tmp.append(": ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.dont_know"));
                }
                str = tmp.toString();
                break;
            default:
                throw new RuntimeException(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.invalid_type") + " (" + type + ")!");
        }
        return str;
    }
...
//        }
    ...
    public void getFins(StringBuffer tmp, boolean endo, boolean library) {
        ...
        if (!library) {
            if (list.size() == 1) {
                if (endo) {
                    tmp.append(" ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.endofin_in")).append(" ");
                } else {
                    tmp.append(" ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.fin_in")).append(" ");
                }
            } else {
                if (endo) {
                    tmp.append(" ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.endofins_in")).append(" ");
                } else {
                    tmp.append(" ").append(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.fins_in")).append(" ");
                }
            }
        }
    ...
    public void setEntity(int entity) {
        if (entity != Sudoku2.BLOCK && entity != Sudoku2.LINE && entity != Sudoku2.COL && entity != Sudoku2.CELL) {
            throw new RuntimeException(PropertyUtil.getProperty("intl/SolutionStep","SolutionStep.invalid_setEntity") + " (" + entity + PropertyUtil.getProperty("intl/SolutionStep",")"));
        }
        this.entity = entity;
    }
