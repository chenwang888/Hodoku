 ...
 */
package hodoku.chinesization.sudoku.util;
...
public class MyFontChooser extends javax.swing.JDialog implements ListSelectionListener {
    ...
    static private String[] styles = {
        PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.regular"),
        PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.italic"),
        PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.bold"),
        PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.bold_italic")
    };
    /**
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/MyFontChooser"); // NOI18N
        setTitle(bundle.getString("MyFontChooser.title")); // NOI18N

        jlSchriftart.setDisplayedMnemonic(PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.jlSchriftart.mnemonic").charAt(0));
        ...
        jlSchriftschnitt.setDisplayedMnemonic(PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.jlSchriftSchnitt.mnemonic").charAt(0));
        ...
        jlSchriftgrad.setDisplayedMnemonic(PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.jlSchriftgrad.mnemonic").charAt(0));
        ...
        jbCancel.setMnemonic(PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.jbCancel.mnemonic").charAt(0));
        ...
        jbOK.setMnemonic(PropertyUtil.getProperty("intl/MyFontChooser","MyFontChooser.jbOK.mnemonic").charAt(0));
