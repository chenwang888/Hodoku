...
public class WriteAsPNGDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/WriteAsPNGDialog"); // NOI18N
        ...
        sizeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.sizeLabel.mnemonic").charAt(0));
        sizeLabel.setLabelFor(sizeTextField);
        sizeLabel.setText(bundle.getString("WriteAsPNGDialog.sizeLabel.text")); // NOI18N

        resolutionLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.resolutionLabel.mnemonic").charAt(0));
        ...
        mmRadioButton.setMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.mmRadioButton.mnemonic").charAt(0));
        ...
        inchRadioButton.setMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.inchRadioButton.mnemonic").charAt(0));
        ...
        pixelRadioButton.setMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.pixelRadioButton.mnemonic").charAt(0));
        ...
        bildSpeichernButton.setMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.bildSpeichernButton.mnemonic").charAt(0));
        ...
        abbrechenButton.setMnemonic(PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.abbrechenButton.mnemonic").charAt(0));
    ...
    private void bildSpeichernButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_bildSpeichernButtonActionPerformed
        ...
        chooser.setFileFilter(new FileNameExtensionFilter(
                "*.png " + PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.files"),
                "png"));
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            if (!name.toLowerCase().endsWith(".png")) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(this, 
                            PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.invalid_filename"),
                            PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.error"),
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.invalid_input_format"),
                        PropertyUtil.getProperty("intl/WriteAsPNGDialog","WriteAsPNGDialog.error"),
                        JOptionPane.ERROR_MESSAGE);
                return;
            }
