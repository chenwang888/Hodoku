...
import hodoku.chinesization.solver.SudokuStepFinder;
import hodoku.chinesization.sudoku.StepConfig;
import hodoku.chinesization.sudoku.Sudoku2;
import hodoku.chinesization.sudoku.dialog.FindAllStepsProgressDialog;
...
//    private boolean krakenFish;
    ...
    public void run() {
        ...
        while (! Thread.interrupted()) {
            switch (actStep) {
                case 0:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.simple_solutions"), actStep);
                ...
                case 9:
                    ...
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.fish") + " " + actStep, actStep);
                ...
                case 18:
                    ...
                    if (isAllStepsEnabled(SolutionType.KRAKEN_FISH) && 
                        ...
                        updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.kraken_fish") + " " + (actStep - 9), actStep);
                    ...
                    break;
                case 19:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.uniqueness"), actStep);
                    ...
                    break;
                case 20:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.chains"), actStep);
                    ...
                    break;
                case 21:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.nice_loops"), actStep);
                    ...
                    break;
                case 22:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.grouped_nice_loops"), actStep);
                    ...
                    break;
                case 23:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.templates"), actStep);
                    ...
                    break;
                case 24:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.als"), actStep);
                ...
                case 25:
                    if (isAllStepsEnabled(SolutionType.FORCING_CHAIN)) {
                        updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.forcing_Chains"), actStep);
                ...
                case 26:
                    if (isAllStepsEnabled(SolutionType.FORCING_NET)) {
                        updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.forcing_Nets"), actStep);
                        steps1 = stepFinder.getAllForcingNets(sudoku);
                        steps.addAll(steps1);
                    }
                    break;
                case 27:
                    updateProgress(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.progress_Score"), actStep);
