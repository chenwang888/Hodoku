...
import hodoku.chinesization.sudoku.dialog.PrintSolutionDialog;
...
//        solutionTabbedPane.add("Lösung 3", solutionScrollPane);
    ...
    private void initComponents() {
        ...
        deleteFromHereMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.deleteFromHereMenuItem.mnemonic").charAt(0));
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/SolutionPanel"); // NOI18N
        ...
        toStepMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.toStepMenuItem.mnemonic").charAt(0));
        ...
        solveFromHereMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.solveFromHereMenuItem.mnemonic").charAt(0));
        ...
        tabNewMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.tabNewMenuItem.mnemonic").charAt(0));
        ...
        tabNewNameMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.tabNewNameMenuItem.mnemonic").charAt(0));
        ...
        tabDeleteMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.tabDeleteMenuItem.mnemonic").charAt(0));
        ...
        tabPrintMenuItem.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.tabPrintMenuItem.mnemonic").charAt(0));
        ...
        weiterButton.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.weiterButton.mnemonic").charAt(0));
        ...
        alleEinfachenButton.setMnemonic(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.alleEinfachenButton.mnemonic").charAt(0));
        ...
        southPanelLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new Component[] {alleEinfachenButton, weiterButton});
...
private void tabNewNameMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tabNewNameMenuItemActionPerformed
    ...
    String newTitel = JOptionPane.showInputDialog(PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.new_name"), init);
    if (newTitel != null) {
...
//        new PrintSolutionDialog(mainFrame, true, actSteps, mainFrame.getSudokuPanel().getSudoku().getSudoku(ClipboardMode.LIBRARY)).setVisible(true);
    ...
    public void addStep(SolutionStep step) {
        ...
        if (actSteps.get(actSteps.size() - 1).getType() != SolutionType.INCOMPLETE) {
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.cant_add_step"), 
                    PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.error"),
...
//            System.out.println("   foreground: " + Options.getInstance().getDifficultyLevels()[SolutionType.getStepConfig(actSteps.get(i).getType()).getLevel()].getForegroundColor());
    ...
    private void addTabPane(List<SolutionStep> steps) {
        String titel = PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.solution") + 
    ...
    private void deleteTabPane() {
        if (solutionTabbedPane.getTabCount() <= 1) {
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.cant_delete_step"), 
                    PropertyUtil.getProperty("intl/SolutionPanel","SolutionPanel.error"),
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
