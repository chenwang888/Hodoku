...
import hodoku.chinesization.sudoku.dialog.ConfigDialog;
...
//        stepsTree.setCellRenderer(new ScalableRenderer());
    ...
    private void initComponents() {
        ...
        findButton.setMnemonic(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.findButton.mnemonic").charAt(0));
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/AllStepsPanel"); // NOI18N
        ...
        addToSolutionButton.setMnemonic(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.addToSolution.mnemonic").charAt(0));
    ...
    private void addToSolutionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToSolutionButtonActionPerformed
        ...
        if (actStep == null) {
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.no_solution_selected"),
                    PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void findButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findButtonActionPerformed
        if (sudoku == null) {
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.sudoku_not_set"),
                    PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.error"), JOptionPane.ERROR_MESSAGE);
            return;
        }
        resetTreeNodes();
    ...
    public void resetPanel() {
        model = new DefaultTreeModel(new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.no_solutions")));
        steps = null;
    ...
    private void adjustToggleButtons() {
        ...
        for (int i = 0; i < toggleButtons.length; i++) {
            ...
            if (i ==  instance.getAllStepsSortMode()) {
    ...
    private void resetTreeNodes() {
        ...
        root.setUserObject(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.searching"));
        model.reload();
    ...
    private void createTreeNodes(int sortMode) {
        ...
        if (steps == null || steps.isEmpty()) {
            root.setUserObject(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.no_solution"));
            stepsTree.setRootVisible(true);
            model.reload();
            stepsTree.repaint();
            return;
    ...
    private void createTreeNodesTypes(DefaultMutableTreeNode root) {
        ...
        // now build the tree
        root.setUserObject(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.possible_steps"));
    ...
    private void createTreeNodesCells(DefaultMutableTreeNode root) {
        ...
        for (Entry<Integer, List<SolutionStep>> entry : map.entrySet()) {
            ...
            // new candidate
            lastCat2 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.candidate") +
                    " " + candidate);
    ...
    private void createTreeNodesSingles(DefaultMutableTreeNode root) {
        ...
        for (SolutionStep step : steps) {
            ...
            if (lastStep == null || step.getProgressScoreSingles() != lastStep.getProgressScoreSingles()) {
                // new top category
                lastCat1 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.singles") +
                        " " + step.getProgressScoreSingles());
                root.add(lastCat1);
                lastCat2 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.score") +
    ...
    private void createTreeNodesDirectSingles(DefaultMutableTreeNode root) {
        ...
        for (SolutionStep step : steps) {
            ...
            if (lastStep == null || step.getProgressScoreSinglesOnly() != lastStep.getProgressScoreSinglesOnly()) {
                // new top category
                lastCat1 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.direct_singles") +
                        " " + step.getProgressScoreSinglesOnly());
                root.add(lastCat1);
                lastCat2 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.singles") +
                        " " + step.getProgressScoreSingles());
                lastCat1.add(lastCat2);
                lastCat3 = new DefaultMutableTreeNode(PropertyUtil.getProperty("intl/AllStepsPanel","AllStepsPanel.score") +
                        " " + step.getProgressScore());
