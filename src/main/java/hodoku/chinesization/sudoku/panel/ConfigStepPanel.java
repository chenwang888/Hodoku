...
public class ConfigStepPanel extends javax.swing.JPanel {
    ...
    private static String[] fishDisplayTypes = {
        PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.fishDisplayTypeLabel.text1"),
        PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.fishDisplayTypeLabel.text2"),
        PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.fishDisplayTypeLabel.text3")
    };
    ...
    private void initComponents() {
        ...
        resetButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.resetButton.mnemonic").charAt(0));
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigStepPanel"); // NOI18N
        ...
        maxTableEntryLengthLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.maxTableEntryLengthLabel.mnemonic").charAt(0));
        ...
        lookAheadLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.lookAheadLabel.mnemonic").charAt(0));
        ...
        onlyOneChainCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.onlyOneChainCheckBox.mnemonic").charAt(0));
        ...
        allowAlsInTablingCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","allowAlsInTablingCheckBox.mnemonic").charAt(0));
        ...
        useZeroInsteadOfDotCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.useZeroInsteadOfDotCheckBox.mnemonic").charAt(0));
        useZeroInsteadOfDotCheckBox.setText(bundle.getString("ConfigStepPanel.useZeroInsteadOfDotCheckBox.text")); // NOI18N

        erWithTwoCandidatesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.erWithTwoCandidatesCheckBox.mnemonic").charAt(0));
        erWithTwoCandidatesCheckBox.setText(bundle.getString("ConfigStepPanel.erWithTwoCandidatesCheckBox.text")); // NOI18N

        allowDualsAndSiameseCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.allowDualsAndSiameseCheckBoxMnemonic").charAt(0));
        allowDualsAndSiameseCheckBox.setText(bundle.getString("ConfigStepPanel.allowDualsAndSiameseCheckBox.text")); // NOI18N

        allowMissingCandidatesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.allowMissingCandidatesCheckBox.mnemonic").charAt(0));
        ...
        allowAlsOverlapCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","allowAlsOverlapCheckBox.mnemonic").charAt(0));
        allowAlsOverlapCheckBox.setText(bundle.getString("ConfigStepPanel.allowAlsOverlapCheckBox.text")); // NOI18N

        onlyOneAlsStepCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.onlyOneAlsStepCheckBox.mnemonic").charAt(0));
        ...
        maxFinsLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.maxFinsLabel.mnemonic").charAt(0));
        maxFinsLabel.setText(bundle.getString("ConfigStepPanel.maxFinsLabel.text")); // NOI18N

        maxEndoFinsLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.maxEndoFinsLabel.mnemonic").charAt(0));
        maxEndoFinsLabel.setText(bundle.getString("ConfigStepPanel.maxEndoFinsLabel.text")); // NOI18N

        fishDisplayTypeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.fishDisplayTypeLabel.mnemonic").charAt(0));
        ...
        checkTemplatesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.checkTemplatesCheckBox.mnemonic").charAt(0));
        ...
        onlyOneFishCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.onlyOneFishCheckBox.mnemonic").charAt(0));
        ...
        restrictChainSizeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.restrictChainSizeLabel.mnemonic").charAt(0));
        restrictChainSizeLabel.setText(bundle.getString("ConfigStepPanel.restrictChainSizeLabel.text")); // NOI18N

        restrictChainSizeCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","ConfigStepPanel.restrictChainSizeCheckBox.mnemonic").charAt(0));
        ...
        krakenFishMaxEndoFinsLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","krakenFishMaxEndoFinsLabel.mnemonic").charAt(0));
        ...
        krakenFishMaxFinsLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","krakenFishMaxFinsLabel.mnemonic").charAt(0));
        ...
        krakenFishTypeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","krakenFishTypeLabel.mnemonic").charAt(0));
        ...
        krakenFishMaxSizeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigStepPanel","krakenFishMaxSizeLabel.mnemonic").charAt(0));
