...
implements ListDragAndDropChange {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigSolverPanel"); // NOI18N
        ...
        levelLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.levelLabel.mnemonic").charAt(0));
        levelLabel.setLabelFor(levelComboBox);
        levelLabel.setText(bundle.getString("ConfigSolverPanel.levelLabel.text")); // NOI18N

        scoreLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.scoreLabel.mnemonic").charAt(0));
        ...
        upButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.upButton.mnemonic").charAt(0));
        ...
        downButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.downButton.mnemonic").charAt(0));
        ...
        resetButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.resetButton.mnemonic").charAt(0));
    ...
    class MyDocumentListener implements DocumentListener {
        ...
        private void update(DocumentEvent e) {
            ...
            try {
                ...
                MessageFormat formatter = new MessageFormat(PropertyUtil.getProperty("intl/ConfigSolverPanel.invalid_value","MainFrame.invalid_filename"));
                String msg = formatter.format(new Object[] { txt });
                JOptionPane.showMessageDialog(null, msg,
                        PropertyUtil.getProperty("intl/ConfigSolverPanel","ConfigSolverPanel.invalid_input"), JOptionPane.ERROR_MESSAGE);
            }
        }
    }
}
