...
import hodoku.chinesization.sudoku.ListDragAndDrop;
import hodoku.chinesization.sudoku.ListDragAndDropChange;
...
implements ListDragAndDropChange {
    ...
    private void initComponents() {
        ...
        upButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.upButton.mnemonic").charAt(0));
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigProgressPanel"); // NOI18N
        ...
        downButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.downButton.mnemonic").charAt(0));
        ...
        resetButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.resetButton.mnemonic").charAt(0));
        ...
        sstsButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.sstsButton.mnemonic").charAt(0));
        ...
        mediumButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.mediumButton.mnemonic").charAt(0));
        ...
        mediumPlusHardButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.mediumPlusHardButton.mnemonic").charAt(0));
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new Component[] {downButton, upButton});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new Component[] {mediumButton, mediumPlusHardButton, resetButton, sstsButton});
    ...
    private void checkSteps() {
        if (invalidTypes.size() > 0) {
            ...
            JOptionPane.showMessageDialog(this,
                    PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.techniques") +
                    buffer.toString(),
                    PropertyUtil.getProperty("intl/ConfigProgressPanel","ConfigProgressPanel.error"),
