...
public class ConfigColorkuPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigColorkuPanel"); // NOI18N
        ...
        resetButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigColorkuPanel","ConfigColorkuPanel.resetButton.mnemonic").charAt(0));
    ...
    private void chooseColor(int index) {
        ...
        Color color = JColorChooser.showDialog(this, PropertyUtil.getProperty("intl/ConfigColorPanel","ConfigColorPanel.choose_color"), init);
        if (color != null) {
            colors[index] = color;
