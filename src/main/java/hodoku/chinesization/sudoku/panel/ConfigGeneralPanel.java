...
public class ConfigGeneralPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigGeneralPanel"); // NOI18N
        ...
        showCandidatesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.showCandidatesCheckBox.mnemonic").charAt(0));
        ...
        showWrongValuesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.showWrongValuesCheckBox.mnemonic").charAt(0));
        ...
        showDeviationsCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.showDeviationsCheckBox.mnemonic").charAt(0));
        ...
        saveWindowLayoutCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.saveWindowLayoutCheckBox.mnemonic").charAt(0));
        ...
        localLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.localLabel.mnemonic").charAt(0));
        localLabel.setLabelFor(localComboBox);
        localLabel.setText(bundle.getString("ConfigGeneralPanel.localLabel.text")); // NOI18N

        lookAndFeelLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.lookAndFeelLabel.mnemonic").charAt(0));
        ...
        fontSizeLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.fontSizeLabel.mnemonic").charAt(0));
        ...
        showColorKuCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.showColorKuCheckBox.mnemonic").charAt(0));
        ...
        defaultSizeCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.defaultSizeCheckBox.mnemonic").charAt(0));
        ...
        resetButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.resetButton.mnemonic").charAt(0));
        ...
        shiftKeyCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.shiftKeyCheckBox.mnemonic").charAt(0));
        shiftKeyCheckBox.setText(bundle.getString("ConfigGeneralPanel.shiftKeyCheckBox.text")); // NOI18N

        onlySmallCursorsCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.onlySmallCursorsCheckBox.mnemonic").charAt(0));
        onlySmallCursorsCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallCursorsCheckBox.text")); // NOI18N

        colorValuesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.colorValuesCheckBox.mnemonics").charAt(0));
        colorValuesCheckBox.setText(bundle.getString("ConfigGeneralPanel.colorValuesCheckBox.text")); // NOI18N

        showSudokuSolvedCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.showSudokuSolvedCheckBox.mnemonic").charAt(0));
        showSudokuSolvedCheckBox.setText(bundle.getString("ConfigGeneralPanel.showSudokuSolvedCheckBox.text")); // NOI18N

        deleteCursorAfterCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.deleteCursorAfterCheckBox.mnemonic").charAt(0));
        ...
        toggleFilterAndOrCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.toggleFilterAndOrCheckBox.mnemonic").charAt(0));
        toggleFilterAndOrCheckBox.setText(bundle.getString("ConfigGeneralPanel.toggleFilterAndOrCheckBox.text")); // NOI18N

        alternativeMouseModeCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.alternativeMouseModeCheckBox.mnemonic").charAt(0));
        alternativeMouseModeCheckBox.setText(bundle.getString("ConfigGeneralPanel.alternativeMouseModeCheckBox.text")); // NOI18N

        onlySmallFiltersCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.onlySmallFiltersCheckBox.mnemonic").charAt(0));
        onlySmallFiltersCheckBox.setText(bundle.getString("ConfigGeneralPanel.onlySmallFiltersCheckBox.text")); // NOI18N

        editModeAutoAdvanceCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.editModeAutoAdvanceCheckBox.mnemonic").charAt(0));
        editModeAutoAdvanceCheckBox.setText(bundle.getString("ConfigGeneralPanel.editModeAutoAdvanceCheckBox.text")); // NOI18N

        drawExtraBoxesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ConfigGeneralPanel","ConfigGeneralPanel.drawExtraBoxesCheckBox.mnemonic").charAt(0));
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new Component[] {jPanel2, jPanel4});
    ...
    public void okPressed() {
        ...
        if ((! Options.getInstance().isUseDefaultFontSize() && (oldUseDefaultFontSize || oldFontSize != Options.getInstance().getCustomFontSize())) ||
            ...
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/ConfigGeneralPanel","GeneralConfigPanel.restart_program2"));
        }
        
        language = availableIsoLanguages.get(localComboBox.getSelectedIndex());
        if (! language.equals(Options.getInstance().getLanguage())) {
            JOptionPane.showMessageDialog(this, PropertyUtil.getProperty("intl/ConfigGeneralPanel","GeneralConfigPanel.restart_program"));
        }
...
//                }
    ...
    private void initAll(boolean setDefault) {
        ...
        localComboBox.addItem(PropertyUtil.getProperty("intl/ConfigGeneralPanel","GeneralConfigPanel.automatic"));
        int languageIndex = 0;
    ...
    private void initLafs() {
        ...
        availableLafs.add(PropertyUtil.getProperty("intl/ConfigGeneralPanel","GeneralConfigPanel.system_default"));
