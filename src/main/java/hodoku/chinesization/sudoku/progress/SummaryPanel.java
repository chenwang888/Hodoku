...
package hodoku.chinesization.sudoku.progress;
...
public class SummaryPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/SummaryPanel"); // NOI18N
    ...
    class SummaryTableModel extends AbstractTableModel {
        private static final long serialVersionUID = 1L;
        String[] columnNames = { PropertyUtil.getProperty("intl/SummaryPanel","SummaryPanel.count"), PropertyUtil.getProperty("intl/SummaryPanel","SummaryPanel.technique"), PropertyUtil.getProperty("intl/SummaryPanel","SummaryPanel.score") };
        Object[][] content = { { "", "", "", null } };
        ...
        public void initialize(SudokuSolver solver) {
            if (solver != null) {
                ...
                content[index][1] = PropertyUtil.getProperty("intl/SummaryPanel","SummaryPanel.sum");
