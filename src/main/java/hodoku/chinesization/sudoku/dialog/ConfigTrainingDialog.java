...
import hodoku.chinesization.sudoku.panel.ConfigTrainigPanel;
...
public class ConfigTrainingDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigTrainingDialog"); // NOI18N
        setTitle(bundle.getString("ConfigTrainingDialog.title")); // NOI18N

        okButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigTrainingDialog","ConfigTrainingDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigTrainingDialog","ConfigTrainingDialog.cancelButton.mnemonic").charAt(0));
    ...
    private void okButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        try {
            ...
            MessageFormat formatter = new MessageFormat(
                    PropertyUtil.getProperty("intl/MainFrame", "MainFrame.invalid_filename"));
            String msg = formatter.format(new Object[] { ex.getLocalizedMessage() });
            JOptionPane.showMessageDialog(this, msg,
                    PropertyUtil.getProperty("intl/ConfigDialog","ConfigDialog.error"), JOptionPane.ERROR_MESSAGE);
        }
        okPressed = true;
        setVisible(false);
