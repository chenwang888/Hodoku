...
public class HistoryDialog extends javax.swing.JDialog {
    ...
    private String[] columnNames = new String[] {
        PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.col1"),
        PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.col2"),
        PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.col3"),
        PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.col4")
    };
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/HistoryDialog"); // NOI18N
        ...
        okButton.setMnemonic(PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.cancelButton.mnemonic").charAt(0));
        ...
        previewCheckBox.setMnemonic(PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.previewCheckBox.mnemonic").charAt(0));
    ...
    private void okButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (historyTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this,
                    PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.error.message"),
                    PropertyUtil.getProperty("intl/HistoryDialog","HistoryDialog.error.title"),
