...
//    private Sudoku2 solvedSudoku;
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/BackdoorSearchDialog"); // NOI18N
        ...
        cellsCheckBox.setMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchPanel.cellsCheckBox.mnemonic").charAt(0));
        ...
        candidatesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchPanel.candidatesCheckBox.mnemonic").charAt(0));
        ...
        candLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchPanel.candLabel.mnemonic").charAt(0));
        ...
        startButton.setMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.startButton.mnemonic").charAt(0));
        ...
        closeButton.setMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.stopButton.mnemonic").charAt(0));
        ...
        stopButton.setMnemonic(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.closeButton.mnemonic").charAt(0));
        ...
        if (visible) {
            ...
            if (anz <= 16) {
                JOptionPane.showMessageDialog(this,
                        PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.error.message") + " (" + anz + ")",
                        PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.error.title"), JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
...
//        System.out.println("Thread started!");
        ...
        // normal end
        setFinished(true);
        triggerUpdateProgressbar(PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.searchLabel.text"), 100, 100);
        EventQueue.invokeLater(updateRunnable);
...
//            System.out.println("adjust: stopped");
    ...
    private boolean checkCandidates(int depth, int max, List<Candidate> candidates, StepConfig[] stepConfigs)
        ...
        int counter = 0;
        String startStr = PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_candidates") + " (";
        if (stepConfigs == null) {
            startStr += PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.singles");
        } else {
            startStr += PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.progress");
        }
        startStr += " - ";
        String label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_candidates1");
        if (depth == 2) {
            label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_candidates2");
        } else if (depth == 3) {
            label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_candidates3");
        }
        label += ")";
        for (int i = 0; i < end; i++) {
            if (depth == 1) {
    ...
    private boolean checkSingles(int depth, int max, StepConfig[] stepConfigs)
        ...
        int counter = 0;
        String startStr = PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_cells") + " (";
        if (stepConfigs == null) {
            startStr += PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.singles");
        } else {
            startStr += PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.progress");
        ...
        startStr += " - ";
        String label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_cells1");
        if (depth == 2) {
            label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_cells2");
        } else if (depth == 3) {
            label = startStr + PropertyUtil.getProperty("intl/BackdoorSearchDialog","BackdoorSearchDialog.search_cells3");
        }
        label += ")";
        for (int i = 0; i < end; i++) {
