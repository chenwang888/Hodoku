...
public class RestoreSavePointDialog extends javax.swing.JDialog {
    ...
    private String[] columnNames = new String[]{
        PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.col1"),
        PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.col2")
    };
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/RestoreSavePoint"); // NOI18N
        setTitle(bundle.getString("title")); // NOI18N

        okButton.setMnemonic(PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.cancelButton.mnemonic").charAt(0));
    ...
    private void okButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        if (savePointTable.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(this,
                    PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.error.message"),
                    PropertyUtil.getProperty("intl/RestoreSavePoint","RestoreSavePointDialog.error.title"),
