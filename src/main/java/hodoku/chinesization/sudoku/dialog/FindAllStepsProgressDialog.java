...
public class FindAllStepsProgressDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/FindAllStepsProgressDialog"); // NOI18N
        ...
        abbrechenButton.setMnemonic(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.abbrechenButton.mnemonic").charAt(0));
    ...
    public void updateProgress(final String label, final int step) {
        EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                progressLabel.setText(PropertyUtil.getProperty("intl/FindAllStepsProgressDialog","FindAllStepsProgressDialog.searching") + " " + label);
