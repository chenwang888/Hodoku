...
public class FishChooseCandidatesDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/FishChooseCandidatesDialog"); // NOI18N
        ...
        cand1CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand1CheckBox.mnemonic").charAt(0));
        cand1CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand1CheckBox.text")); // NOI18N

        cand2CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand2CheckBox.mnemonic").charAt(0));
        cand2CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand2CheckBox.text")); // NOI18N

        cand3CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand3CheckBox.mnemonic").charAt(0));
        cand3CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand3CheckBox.text")); // NOI18N

        cand4CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand4CheckBox.mnemonic").charAt(0));
        cand4CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand4CheckBox.text")); // NOI18N

        cand5CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand5CheckBox.mnemonic").charAt(0));
        cand5CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand5CheckBox.text")); // NOI18N

        cand6CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand6CheckBox.mnemonic").charAt(0));
        cand6CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand6CheckBox.text")); // NOI18N

        cand7CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand7CheckBox.mnemonic").charAt(0));
        cand7CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand7CheckBox.text")); // NOI18N

        cand8CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand8CheckBox.mnemonic").charAt(0));
        cand8CheckBox.setText(bundle.getString("FishChooseCandidatesDialog.cand8CheckBox.text")); // NOI18N

        cand9CheckBox.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cand9CheckBox.mnemonic").charAt(0));
        ...
        okButton.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","cancelButton.mnemonic").charAt(0));
        ...
        clearAllButton.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","clearAllButton.mnemonic").charAt(0));
        ...
        setAllButton.setMnemonic(PropertyUtil.getProperty("intl/FishChooseCandidatesDialog","setAllButton.mnemonic").charAt(0));
