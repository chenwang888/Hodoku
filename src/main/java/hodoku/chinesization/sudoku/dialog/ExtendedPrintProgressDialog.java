...
public class ExtendedPrintProgressDialog extends javax.swing.JDialog implements Runnable, Printable {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ExtendedPrintProgressDialog"); // NOI18N
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintProgressDialog","ExtendedPrintProgressDialog.cancelButton.mnemonic").charAt(0));
...
//        printG2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
    ...
    private void setProgress() {
        ...
        if (value >= 0) {
            setTitle(PropertyUtil.getProperty("intl/ExtendedPrintProgressDialog","ExtendedPrintProgressDialog.title"));
            printProgressBar.setValue(value);
            printProgressBar.setString(value + " %");
        } else {
            value = -value;
            setTitle(PropertyUtil.getProperty("intl/ExtendedPrintProgressDialog","ExtendedPrintProgressDialog.title2"));
    ...
    private void showMessageDialog() {
        int ret = JOptionPane.showConfirmDialog(null, 
                PropertyUtil.getProperty("intl/ExtendedPrintProgressDialog","ExtendedPrintProgressDialog.flipPaper"),
                PropertyUtil.getProperty("intl/ExtendedPrintProgressDialog","ExtendedPrintProgressDialog.flipPaperTitle"),
