...
public class SetGivensDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/SetGivensDialog"); // NOI18N
        ...
        okButton.setMnemonic(PropertyUtil.getProperty("intl/SetGivensDialog","SetGivensDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/SetGivensDialog","SetGivensDialog.cancelButton.mnemonics").charAt(0));
...
//        System.out.println("givens <" + givens + ">");
        if (givens.length() != 81) {
            JOptionPane.showMessageDialog(rootPane, 
                    PropertyUtil.getProperty("intl/SetGivensDialog","SetGivensDialog.error.message"),
                    PropertyUtil.getProperty("intl/SetGivensDialog","SetGivensDialog.error.title"),
