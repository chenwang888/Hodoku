...
public class ExtendedPrintDialog extends javax.swing.JDialog {
    ...
    // FIXME 修改加载顺序，去除 statis
    private final String[] modeNames = new String[] {
        PropertyUtil.getProperty("intl/MainFrame","MainFrame.playingMenuItem.text"),
        PropertyUtil.getProperty("intl/MainFrame","MainFrame.learningMenuItem.text"),
        PropertyUtil.getProperty("intl/MainFrame","MainFrame.practisingMenuItem.text")
    };
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ExtendedPrintDialog"); // NOI18N
        ...
        printRatingCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.printRatingCheckBox.mnemonic").charAt(0));
        ...
        printAllBlackCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.printAllBlackCheckBox.mnemonic").charAt(0));
        printAllBlackCheckBox.setText(bundle.getString("ExtendedPrintDialog.printAllBlackCheckBox.text")); // NOI18N

        printBookletCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.printBookletCheckBox.mnemonic").charAt(0));
        ...
        manualDuplexCheckBox.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.manualDuplexCheckBox.mnemonic").charAt(0));
        ...
        printButton.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.printButton.mnemonic").charAt(0));
        ...
        pageSetupButton.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.pageSetupButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.cancelButton.mnemonic").charAt(0));
    ...
    private void printButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        ...
        if (totalNumberOfPuzzles == 0) {
            ...
            JOptionPane.showMessageDialog(this, 
                    PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.noPuzzles"),
        ...
        if (printBooklet && layout < 3) {
            ...
            JOptionPane.showMessageDialog(this, 
                    PropertyUtil.getProperty("intl/ExtendedPrintDialog","ExtendedPrintDialog.wrongOrientation"),
                    PropertyUtil.getProperty("intl/MainFrame","MainFrame.error"),
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
