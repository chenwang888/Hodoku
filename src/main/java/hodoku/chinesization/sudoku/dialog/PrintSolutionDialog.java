...
public class PrintSolutionDialog extends javax.swing.JDialog implements Printable {
    ...
    private void initComponents() {
        ...
        ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/PrintSolutionDialog"); // NOI18N
        ...
        widthLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.widthLabel.mnemonic").charAt(0));
        ...
        compressSinglesCheckBox.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.compressSinglesCheckBox.mnemonic").charAt(0));
        ...
        compressSSTSCheckBox.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.compressSSTSCheckBox.mnemonic").charAt(0));
        ...
        titleLabel.setDisplayedMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.titleLabel.mnemonic").charAt(0));
        ...
        printButton.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.printButton.mnemonic").charAt(0));
        ...
        copyButton.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.copyButton.mnemonic").charAt(0));
        ...
        pageOptionsButton.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.pageOptionsButton.mnemonic").charAt(0));
        ...
        closeButton.setMnemonic(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.closeButton.mnemonic").charAt(0));
...
//        }
    ...
    private void copyToClipboard() {
        ...
        // Givens
        out.println(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.givens"));
        out.println(sudoku.getSudoku(ClipboardMode.CLUES_ONLY));
        out.println();
        // InitialState
        out.println(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.initialState"));
        ...
        for (int i = 0; i < steps.length; i++) {
            if (compressSinglesCheckBox.isSelected() && SolutionType.isSingle(steps[i].getType()) ||
                ...
                if (compressedStarted) {
                    ...
                    out.println();
                    if (isSingles) {
                        out.println(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.singlesTo"));
                    } else {
                        out.println(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.sstsTo"));
                    }
                    out.println(sudoku.getSudoku(ClipboardMode.PM_GRID));
                    compressedStarted = false;
                }
        ...
        // print the solution
        out.println();
        out.println(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.solution"));
        out.println(sudoku.getSudoku(ClipboardMode.PM_GRID));
...
//        printG2.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING, RenderingHints.VALUE_TEXT_ANTIALIAS_ON);
        ...
        if (pageIndex == 0) {
            ...
            // Givens
            y += lineHeight;
            printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.givens"), 0, y);
            ...
            y += lineHeight;
            printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.initialState"), 0, y);
            panel.setStep(null);
        ...
        for ( ; printIndex < steps.length; printIndex++) {
            if (compressSinglesCheckBox.isSelected() && SolutionType.isSingle(steps[printIndex].getType()) ||
                ...
                if (compressedStarted) {
                    ...
                    y += lineHeight / 2;
                    if (isSingles) {
                        printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.singlesTo"), 0, y);
                    } else {
                        printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.sstsTo"), 0, y);
                    }
                    panel.setStep(null);
                    BufferedImage img = panel.getSudokuImage(imagePrintSize);
                    y += lineHeight / 2;
        ...
        if (compressedStarted) {
            ...
            y += lineHeight / 2;
            if (isSingles) {
                printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.singlesToEnd"), 0, y);
            } else {
                printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.sstsToEnd"), 0, y);
            }
            compressedStarted = false;
        }
        // print the solution
        ...
        y += lineHeight;
        y += lineHeight / 2;
        printG2.drawString(PropertyUtil.getProperty("intl/PrintSolutionDialog","PrintSolutionDialog.solution"), 0, y);
        panel.setStep(null);
        BufferedImage img = panel.getSudokuImage(imagePrintSize);
        y += lineHeight / 2;
        printG2.drawImage(img, null, 0, y);
