...
import hodoku.chinesization.sudoku.panel.*;
...
public class ConfigDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        java.util.ResourceBundle bundle = PropertyUtil.loadResourceFile("intl/ConfigDialog"); // NOI18N
        ...
        okButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigDialog","ConfigDialog.okButton.mnemonic").charAt(0));
        ...
        cancelButton.setMnemonic(PropertyUtil.getProperty("intl/ConfigDialog","ConfigDialog.cancelButton.mnemonic").charAt(0));
    ...
    private void okButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        try {
            ...
            MessageFormat formatter = new MessageFormat(PropertyUtil.getProperty("intl/MainFrame","MainFrame.invalid_filename"));
