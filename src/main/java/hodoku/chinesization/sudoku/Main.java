...
import hodoku.chinesization.sudoku.solver.FindAllSteps;
import hodoku.chinesization.sudoku.solver.RegressionTester;
...
//        rootLogger.setLevel(Level.ALL);
        ...
        //选项列表(macht getInstance())
        //如果一个文件hodoku。HCFG存在于程序所在的目录中
        //启动后，自动加载
        Options.getInstance();
        String path = System.getProperty("launch4j.exedir");
        if (path == null) {
            URL startURL = Main.class.getResource("/hodoku/chinesization/sudoku/Main.class");
            ...
            if (path.contains(".jar!")) {
                ...
                // 从 jar 文件开始:只查找路径
                // 格式为:file:/C:/Sudoku/hodoku.jar!/ Sudoku/ Main.class
                // 格式在Ubuntu: file:/home/Ubuntu/Desktop/hodoku.jar!/sudoku/Main.class
                int startIndex = 5;
