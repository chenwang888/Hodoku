...
import hodoku.chinesization.sudoku.entity.Candidate;
import hodoku.chinesization.sudoku.entity.Chain;
...
import hodoku.chinesization.sudoku.SudokuSetBase;
...
//        System.out.println(tmpBuffer);
    ...
    /**
     * Find all Kraken Fishes. Arguments see {@link #getAllFishes(int, int, int, int, FindAllStepsProgressDialog, int, int)}.
     * @param minSize
     * @param maxSize
     * @param maxFins
     * @param maxEndoFins
